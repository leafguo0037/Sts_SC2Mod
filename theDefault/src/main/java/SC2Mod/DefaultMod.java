...
import SC2Mod.events.IdentityCrisisEvent;
import SC2Mod.potions.PlaceholderPotion;
import SC2Mod.relics.BottledPlaceholderRelic;
import SC2Mod.relics.DefaultClickableRelic;
import SC2Mod.relics.PlaceholderRelic;
import SC2Mod.relics.PlaceholderRelic2;
import SC2Mod.util.IDCheckDontTouchPls;
import SC2Mod.util.TextureLoader;
import SC2Mod.variables.DefaultCustomVariable;
import SC2Mod.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    private static final String ATTACK_DEFAULT_GRAY = "SC2ModResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "SC2ModResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "SC2ModResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "SC2ModResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "SC2ModResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "SC2ModResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "SC2ModResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "SC2ModResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "SC2ModResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "SC2ModResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "SC2ModResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "SC2ModResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "SC2ModResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "SC2ModResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "SC2ModResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "SC2ModResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "SC2ModResources/images/char/defaultCharacter/skeleton.json";
