...
import SC2Mod.patches.relics.BottledPlaceholderField;
import SC2Mod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static SC2Mod.DefaultMod.makeRelicOutlinePath;
import static SC2Mod.DefaultMod.makeRelicPath;
