...
public class Phoenix_Y extends AbstractDefaultCard {

    public static final String ID = "Phoenix_Y";
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Attack.png");

    public static final String NAME = "凤凰";
    public static String[] DESCRIPTION = {"造成!D!点伤害,1层虚弱","次，消耗"};
